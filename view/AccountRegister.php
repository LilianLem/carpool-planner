	...
	<body>
		...
		<main>
			...
			<form id="register-form" class="basic-form" method="post" action="index.php?action=registration">
				...
				<input type="text" name="discord-username" id="discord-username" placeholder="Ex : Pierre#1234" required="required" maxlength="32" value="<?=$prefilledInfos['discord_username']?>" />
